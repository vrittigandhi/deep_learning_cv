...
class DataSet():
	...
	def __init__(self, cnn_model, 
		...
		self.sequence_path = os.path.join('/Users/shrutigandhi/Documents/Deep_Learning_Project', 'sequences')
	...
	def get_data():
		...
		with open(os.path.join('/Users/shrutigandhi/Documents/Deep_Learning_Project', 'data_file.csv'), 'r') as fin:
	...
	def get_frames_for_sample(self, sample):
		...
		path = os.path.join('/Users/shrutigandhi/Documents/Deep_Learning_Project', sample[1], sample[2] + '.avi')
	...
	def extract_seq_features(self, sample):
		...
		path = os.path.join('/Users/shrutigandhi/Documents/Deep_Learning_Project', 'sequences', sample[1], sample[2] + '-' + str(self.seq_length) + \
		'-features')
