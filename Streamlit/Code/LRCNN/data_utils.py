...
class DataSet():
	...
	def __init__(self, cnn_model, 
		...
		self.sequence_path = os.path.join('/content/drive/MyDrive/DeepLearning_Test/data', 'sequences')
	...
	def get_data():
		...
		with open(os.path.join('/content/drive/MyDrive/DeepLearning_Test/data', 'data_file.csv'), 'r') as fin:
	...
	def get_frames_for_sample(self, sample):
		...
		path = os.path.join('drive/MyDrive/DeepLearning_Test/VIDEO_RGB_NEW', sample[1], sample[2] + '.avi')
	...
	def extract_seq_features(self, sample):
		...
		path = os.path.join('/content/drive/MyDrive/DeepLearning_Test/data', 'sequences', sample[1], sample[2] + '-' + str(self.seq_length) + \
		'-features')
